...
export default function Profile() {
  ...
  // Auto-scroll to the error message whenever it is set
  useEffect(() => {
  ...
  return (
    <section style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 20, padding: 28, display: 'grid', gap: 18, boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
      ...
      {error && (
        <div
          ref={errorRef}
          style={{ background: '#fef2f2', border: '1px solid #fee2e2', borderRadius: 12, padding: '12px 14px', color: '#991b1b', fontSize: 12, fontWeight: 500 }}
        >
          {error}
        </div>
      )}
